-- =============================================================================
-- SLASH OFFCHAIN DELEGATION COMMITMENT TABLE
-- =============================================================================

CREATE TABLE slash_offchain_delegation_commitment (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  chain_id INTEGER NOT NULL,
  operator_data_id UUID,
  signed_delegation_id UUID,
  ...
  slashing_digest BYTEA,
  created_at TIMESTAMPTZ DEFAULT NOW(),
  updated_at TIMESTAMPTZ DEFAULT NOW(),
  writer_id UUID,
  FOREIGN KEY (operator_data_id) REFERENCES operator_data(id),
  FOREIGN KEY (signed_delegation_id) REFERENCES signed_delegation(id),
...
SELECT trigger_audit_log('slash_offchain_delegation_commitment');
SELECT trigger_updated_at('slash_offchain_delegation_commitment');
