...
CREATE TABLE "operator_registration_events" (
...
ALTER TABLE "operator_registration_events" ADD FOREIGN KEY ("event_id") REFERENCES "events" ("id");

ALTER TABLE "operator_registration_events" ADD FOREIGN KEY ("operator_id") REFERENCES "operators" ("id");

ALTER TABLE "operator_registration_events" ADD FOREIGN KEY ("writer_id") REFERENCES "writers" ("id");

SELECT trigger_audit_log('operator_registration_events');
SELECT trigger_updated_at('operator_registration_events');
